...
const entity_1 = __importDefault(require("../modules/products/entity"));
const getAllProducts = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield entity_1.default.find({});
    }
    catch (err) {
        throw err;
    }
...
const getOneProduct = (_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield entity_1.default.findOne({ _id });
    }
    catch (err) {
        throw err;
    }
...
const createProduct = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return yield entity_1.default.create(data);
    }
    catch (err) {
        throw err;
    }
...
const updateProduct = (_id, data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield entity_1.default.updateOne({ _id }, data);
    }
    catch (err) {
        throw err;
    }
...
const deleteProduct = (_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield entity_1.default.deleteOne({ _id });
    }
    catch (err) {
        throw err;
    }
